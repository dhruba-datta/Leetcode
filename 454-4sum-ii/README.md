...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [1,2], nums2 = [-2,-1], nums3 = [-1,2], nums4 = [0,2]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [0], nums2 = [0], nums3 = [0], nums4 = [0]
