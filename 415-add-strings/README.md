...
<pre style="position: relative;"><strong>Input:</strong> num1 = "11", num2 = "123"
<strong>Output:</strong> "134"
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> num1 = "456", num2 = "77"
<strong>Output:</strong> "533"
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> num1 = "0", num2 = "0"
